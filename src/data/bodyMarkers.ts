...
export const BODY_MARKERS: BodyMarkerExplainer[] = [
  ...
  },
  {
    ...
    purpose: "The other half of waist-to-hip ratio",
    note: "The second half of waist-to-hip ratio, and the one thing here no wearable can supply. A hip on its own carries no reference range; the judgement belongs to the ratio.",
    units: ["cm"],
    howTo: [
      "Stand with your feet together.",
      "Pass a non-stretch tape around the widest part of your buttocks.",
      "Keep the tape level all the way around, snug but not compressing.",
    ],
    bands: [],
    citation: "WHO Expert Consultation. Waist Circumference and Waist-Hip Ratio: Report of a WHO Expert Consultation, Geneva, 8-11 December 2008. Substantially increased risk at >=0.90 in men and >=0.85 in women.",
    detail: [
      "Waist-to-hip ratio is waist ÷ hip, both in the same unit. WHO 2008 reads substantially increased risk at 0.90 or above in men and 0.85 or above in women. There are no ethnicity-specific waist-to-hip cut-offs, and Verve does not invent any.",
      "To measure: stand with your feet together, and pass a non-stretch tape around the widest girth at the level of the buttocks, level all the way around and snug without compressing.",
      "This is the complementary measure rather than the default. Waist-to-height needs only the waist and the height already on file, so it appears the moment a waist is recorded; waist-to-hip waits for a measurement someone has to take by hand. The full write-up on what these ratios reclassify, and what the evidence does and does not establish, is under Waist circumference.",
    ],
    references: [
      "WHO Expert Consultation. Waist Circumference and Waist-Hip Ratio: Report of a WHO Expert Consultation, Geneva, 8-11 December 2008. World Health Organization, 2011.",
      "Dardari ZA, Yao Z, Zhang J, et al. Risk Reclassification Beyond BMI by Waist Circumference and Waist-to-Hip Ratio Across 9 Cardiovascular Outcomes: Results From the Cross-Cohort Collaboration. Journal of the American College of Cardiology. 2026.",
